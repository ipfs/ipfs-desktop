...
const regExToReplace: RegExp = new RegExp(
  `((?:ipfs-desktop|IPFS-Desktop-Setup|ipfs-desktop-setup|ipfs-desktop-portable|ipfs-desktop/releases/tag|ipfs-desktop/releases/download)[-/]v?)${oldVersion}`,
  'gm',
)
