...
[![latest release download count](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/total.svg?style=flat-square)](https://github.com/ipfs/ipfs-desktop/releases/tag/v0.47.1)
...
- **Windows:** [ipfs-desktop-setup-0.47.1-win-x64.exe](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-setup-0.47.1-win-x64.exe)
- **Mac:** [ipfs-desktop-0.47.1-mac.dmg](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-mac.dmg)
- **Linux:**  [ipfs-desktop-0.47.1-linux-x86_64.AppImage](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.AppImage)
...
### Windows
- **Installer:** [ipfs-desktop-setup-0.47.1-win-x64.exe](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-setup-0.47.1-win-x64.exe)\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-setup-0.47.1-win-x64.exe.svg?style=flat-square&label=downloads)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-setup-0.47.1-win-x64.exe)
...
- ℹ️ update checks from existing users: [![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/latest.yml.svg?style=flat-square&label=autoupdate)](https://github.com/ipfs/kubo/releases/latest)

### Mac
- **Installer:** [ipfs-desktop-0.47.1-mac.dmg](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-mac.dmg)\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-mac.dmg.svg?style=flat-square&label=downloads)<br/>
![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-squirrel.zip.svg?style=flat-square&label=update)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-mac.dmg)
- **Homebrew** (community-maintained): `brew install --cask ipfs`
- ℹ️ update checks from existing users: [![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/latest-mac.yml.svg?style=flat-square&label=autoupdate)](https://github.com/ipfs/kubo/releases/latest)

### Linux/FreeBSD
- **AppImage**: [ipfs-desktop-0.47.1-linux-x86_64.AppImage](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.AppImage)\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.AppImage.svg?style=flat-square&label=downloads)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.AppImage)
- **Tarball (tar.gz)** (use this for building packages for distros): [ipfs-desktop-0.47.1-linux-x64.tar.xz](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x64.tar.xz)\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-linux-x64.tar.xz.svg?style=flat-square&label=downloads)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x64.tar.xz)
- **Debian (DEB)** (experimental): [ipfs-desktop-0.47.1-linux-amd64.deb](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-amd64.deb)\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-linux-amd64.deb.svg?style=flat-square&label=downloads)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-amd64.deb)
- **Red Hat (RPM)** (experimental): [ipfs-desktop-0.47.1-linux-x86_64.rpm](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.rpm)\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.rpm.svg?style=flat-square&label=downloads)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x86_64.rpm)
- **FreeBSD** (experimental): [ipfs-desktop-0.47.1-linux-x64.freebsd](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x64.freebsd) (requires [Linux Binary Compatibility to be enabled](https://docs.freebsd.org/en/books/handbook/linuxemu/))\
[![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/ipfs-desktop-0.47.1-linux-x64.freebsd.svg?style=flat-square&label=downloads)](https://github.com/ipfs/ipfs-desktop/releases/download/v0.47.1/ipfs-desktop-0.47.1-linux-x64.freebsd)
...
- ℹ️ update checks from existing users: [![](https://img.shields.io/github/downloads/ipfs/ipfs-desktop/v0.47.1/latest-linux.yml.svg?style=flat-square&label=autoupdate)](https://github.com/ipfs/kubo/releases/latest)
