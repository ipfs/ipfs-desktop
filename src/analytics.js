...
module.exports = async function (ctx) {
  ...
  const storage_path = join(app.getPath('home'), './.ipfs-desktop/countly-data')
  ...
  Countly.init({
    ...
    // storage_path for read-only node_modules
    storage_path: join(app.getPath('home'), './.ipfs-desktop/countly-data')
  })
